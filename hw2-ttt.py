...
def check_win_horizontal(board):
    '''Checks the horizontal status of the board in relation to users input

    Will evaluate the three horizontal rows of the board by taking
    the index value of the board

       Parameters
       ----------
       board: list
           with the values of input (1 or 2)
       '''
    if (board[0] != 0 and
            board[0] == board[1] and
            board[0] == board[2]):
...
def check_win_vertical(board):
    '''Checks the vertical status of the board in relation to users input

        Will evaluate the three vertical rows of the board by taking
        the index value of the board
...
def check_win_diagonal(board):
    '''Checks for both o the diagonal status of the board in relation to users input

        Will evaluate the two horizontal rows of the board by taking
        the index value of the board
...
if winner:
    ...
    print(f" Nobody Wins :( Try again friends! ")